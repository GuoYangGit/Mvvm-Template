...
<recipe>
    ...
    <instantiate from="root/src/app_package/GlobalConfiguration.kt.ftl"
                   to="${projectOut}/src/main/java/${slashedPackageName(packageName)}/core/GlobalConfiguration.kt" />
    <instantiate from="root/src/app_package/App.kt.ftl"
                   to="${projectOut}/src/main/java/${slashedPackageName(packageName)}/core/App.kt" />

    <instantiate from="root/src/app_package/AppComponent.kt.ftl"
                   to="${projectOut}/src/main/java/${slashedPackageName(packageName)}/di/component/AppComponent.kt" />
    <instantiate from="root/src/app_package/AppModule.kt.ftl"
                   to="${projectOut}/src/main/java/${slashedPackageName(packageName)}/di/module/AppModule.kt" />
    <instantiate from="root/src/app_package/ActivityModule.kt.ftl"
                   to="${projectOut}/src/main/java/${slashedPackageName(packageName)}/di/module/ActivityModule.kt" />
    <instantiate from="root/src/app_package/FragmentModule.kt.ftl"
                   to="${projectOut}/src/main/java/${slashedPackageName(packageName)}/di/module/FragmentModule.kt" />
    <instantiate from="root/src/app_package/ViewModelModule.kt.ftl"
                   to="${projectOut}/src/main/java/${slashedPackageName(packageName)}/di/module/ViewModelModule.kt" />
